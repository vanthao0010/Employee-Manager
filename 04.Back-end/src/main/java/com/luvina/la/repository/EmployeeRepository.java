...
public interface EmployeeRepository extends JpaRepository<Employee, Long> {
    ...
    @Query("SELECT new com.luvina.la.dto.EmployeeDTO(e.employeeId, e.employeeName, e.employeeBirthDate, " +
            "e.employeeEmail, e.employeeTelephone, d.departmentName,ec.endDate, c.certificationName,  ec.score) " +
            " FROM Employee e " +
    ...
    Page<EmployeeDTO> findByNameOrDepartment(@Param("employeeName") String employeeName , @Param("departmentId") Long departmentId, Pageable pageable);
